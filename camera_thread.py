...
class CameraThread:
    ...
    def toggle(self):
        ...
        if self.is_running:
            ...
            self.writer = cv2.VideoWriter(self.path, self.fourcc, 25.0, (int(self.cap.get(3)), int(self.cap.get(4)) - 40))
    ...
    def _run(self):
        ...
        while True:
            ...
            if image_result.IsIncomplete():
                ...
                cv2.putText(show_data, str(fps), (50, 50), font, fontScale, color, thickness, cv2.LINE_AA)
                ...
                if self.toggle_var.value == 'start':
                    ...
                    if vid_end == 0:
                        ...
                        print('Video Length: ', vid_end - vid_start)
